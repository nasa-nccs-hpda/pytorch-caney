...
def remap_pretrained_keys_swin(
    model,
    checkpoint_model,
    logger,
):
    ...
    for key in all_keys:
        if "relative_position_bias_table" in key:
            ...
            (
                L1,
                nH1,
            ) = rel_position_bias_table_pretrained.size()

            (
                L2,
                nH2,
            ) = rel_position_bias_table_current.size()
            ...
            if nH1 != nH2:
                ...
                if L1 != L2:
                    ...
                    for i in range(nH1):
                        z = (
                            rel_position_bias_table_pretrained[
                                :,
                                i,
                            ]
                            .view(
