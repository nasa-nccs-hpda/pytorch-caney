...
from pytorch_caney.network.pos_embed import get_2d_sincos_pos_embed, get_1d_sincos_pos_embed_from_grid_torch
...
if __name__ == '__main__':
    ...
    sample_x = torch.rand(3, 768)

    import numpy as np

    ts_0 = np.array([2019 - 2002, 8, 10])
    ts_1 = np.array([2019 - 2002, 5, 10])
    ts_2 = np.array([2019 - 2002, 2, 10])

    sample_time_stamps = np.stack([ts_0, ts_1, ts_2], axis=0)

    sample_logits = mae_vit_base(sample_x, sample_time_stamps)