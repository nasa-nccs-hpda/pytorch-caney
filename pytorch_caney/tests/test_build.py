from pytorch_caney.models.build import (
    build_model,
)
...
class TestBuildModel(unittest.TestCase):
    ...
    def test_unknown_decoder_architecture(
        self,
    ):
        self.config.defrost()
