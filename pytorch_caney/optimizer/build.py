import torch
import deepspeed
from pytorch_caney.optimizer.lamb import Lamb
...
#    #                 weight_decay=config.TRAIN.WEIGHT_DECAY)
#
#    optimizer = deepspeed.ops.lamb.FusedLamb(simmim_model.parameters(), lr=config.TRAIN.BASE_LR, weight_decay=config.TRAIN.WEIGHT_DECAY)
...
def build_optimizer(config):
    Builds the optimizer function given a configuration object.

    Args:
        config: config object

    Returns:
        optimizer_to_use: pytorch optimizer function
