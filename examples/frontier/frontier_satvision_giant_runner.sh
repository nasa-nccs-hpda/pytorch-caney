#!/bin/bash
#SBATCH -A geo160
#SBATCH --job-name=satvision-giant-pretraining-100-epoch-test   # create a short name for your job
#SBATCH --nodes=46                # node count
#SBATCH --qos=debug
...
cmd=" pytorch-caney/pytorch_caney/pipelines/pretraining/mim_deepspeed.py --cfg $1 --dataset MODIS --data-paths ${datapaths} --output . --batch-size ${batchsize}"
echo $cmd
