...
validation_path="/discover/nobackup/projects/calebtest/3dclouds.runs/validation_test/data/sv_toa_128_chip_validation_04_24.npy"
...
cmd=" pytorch-caney/pytorch_caney/pipelines/pretraining/mim_deepspeed.py --cfg $1 --dataset MODIS --data-paths /discover/nobackup/projects/calebtest/3dclouds/v3 --output . --batch-size 32 --validation-path ${validation_path} --resume $2"
echo $cmd
