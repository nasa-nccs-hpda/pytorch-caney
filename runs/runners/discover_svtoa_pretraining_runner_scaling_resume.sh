...
cmd=" pytorch-caney/pytorch_caney/pipelines/pretraining/mim_deepspeed_scaling.py --cfg $1 --dataset MODIS --data-paths /discover/nobackup/projects/calebtest/3dclouds/v3 --output . --batch-size 512 --validation-path ${validation_path} --resume $2 "
echo $cmd
